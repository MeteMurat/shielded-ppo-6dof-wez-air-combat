...
plt.title('ATA and Distance vs Time for PPO Simulation')
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.title('Mach and Altitude vs Time for PPO Simulation')
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.title('Altitude Comparison for PPO Simulation')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
