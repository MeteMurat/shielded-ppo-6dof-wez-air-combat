...
plt.title('ATA and Distance vs Time for Hybrid System Simulation', fontsize=11)
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.title('Mach and Altitude vs Time for Hybrid System Simulation', fontsize=11)
plt.grid(True)
plt.tight_layout()
plt.show()
