...
record_index = 9  # En başarılı Record9
...
plt.title('ATA and Distance vs Time for Hybrid Ssystem Simulation')
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.title('Mach and Altitude vs Time for Hybrid System Simulation')
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.title('Altitude Comparison for Hybrid System Simulation')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
