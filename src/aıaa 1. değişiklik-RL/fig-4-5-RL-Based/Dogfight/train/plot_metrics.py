...
record_index = 8  # En başarılı Record8
...
plt.title('ATA and Distance vs Time for RL Based Simulation', fontsize=11)
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.title('Mach and Altitude vs Time for RL Based Simulation', fontsize=11)
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.title('Altitude Comparison for RL Based Simulation', fontsize=11)
