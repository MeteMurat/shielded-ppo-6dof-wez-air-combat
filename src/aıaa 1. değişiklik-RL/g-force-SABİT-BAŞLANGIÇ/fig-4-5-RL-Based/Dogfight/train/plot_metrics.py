...
plt.title('ATA and Distance vs Time for RL Based Simulation')
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.title('Mach and Altitude vs Time for RL Based Simulation')
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.title('Altitude Comparison for RL Based Simulation')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
